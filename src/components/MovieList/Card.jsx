            ...
            <div className='px-4 mx-3'>
                <Slider {...settings}>
                    {Apidata.length != 0 && Apidata[0].results.filter((item) => {
                        ...
                        return <div key={data.id} className='lg:h-[400px] lg:w-[210px] h-[300px] w-[150px] mx-4 p-3 bg-[#5a4661] bg-opacity-50
                    ...
                    hover:border-4 hover:border-orange-500'
                            ...
                            <div >
                                ...
                                <div className='flex justify-between'>
                                    ...
                                    <div>
                                        <p className='lg:px-2 lg:text-[16px] text-[12px] px-1 mt-1 mr-1 bg-black text-white rounded-md'>{data.media_type}</p>
                                    </div>
                                </div>
